...
async function getActivityReports(): Promise<Report[]> {
  try {
    ...
    return all.filter((r) => !r.type || r.type === "activite");
  } catch {
    return [];
  }
}
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-white border-b border-gray-100">
        <div className="mx-auto max-w-7xl px-6 py-16">
          ...
          <h1 className="mt-2 text-4xl font-bold text-gray-900 md:text-5xl">Rapport d'activité</h1>
          <p className="mt-4 max-w-2xl text-gray-600">Consultez nos rapports d'activité annuels.</p>
        </div>
      </div>
      <div className="mx-auto max-w-4xl px-6 py-14">
        {reports.length === 0 ? (
          <div className="flex flex-col items-center py-24 text-center">
            <p className="text-gray-500">Aucun rapport d'activité disponible pour le moment.</p>
